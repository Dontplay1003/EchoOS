...
# 1-4
CPUS="1"
#BIOS="./../qemu/loongarch_bios_0310.bin"
BIOS="./../qemu/loongarch_bios_0310_debug.bin"
KERNEL="./build/kernel"
INITRD="./../qemu/busybox-rootfs.img"
HDC="./disk.img"
USE_GRAPHIC="yes"
DEBUG=''
QEMU="./../qemu/qemu-system-loongarch64"
...
set -x
$QEMU -m $MEM -smp $CPUS -bios $BIOS -kernel $KERNEL -append "$CMDLINE" $GRAPHIC $DEBUG  #-hdc $HDC #-initrd $INITRD
